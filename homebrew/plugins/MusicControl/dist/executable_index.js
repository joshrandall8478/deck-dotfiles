(function (deckyFrontendLib, React) {
  ...
  const Title = () => {
      return (window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: titleStyles, className: deckyFrontendLib.staticClasses.Title },
  ...
  const InfoSection = () => {
      const onClickInfo = () => {
          ...
          deckyFrontendLib.Router.Navigate("/decky/musiccontrol/info");
      };
  ...
  function triggerSetPosition(position, trackid) {
      return server.callPluginMethod("sp_set_position", {
          position: position,
          trackid: trackid,
      });
  }
  function triggerTrackStatus() {
      return server.callPluginMethod("sp_track_status", {});
  }
  function getProviderIdentity(orgPath) {
  ...
  function triggerSetVolume(volume) {
      return server.callPluginMethod("sp_set_volume", { volume });
  }
  function getMediaPlayerList() {
  ...
  const SongProgressSlider = () => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
          window.SP_REACT.createElement(deckyFrontendLib.SliderField, { value: state.currentTrackProgress / state.currentTrackLength, min: 0, max: 1, step: 0.05, disabled: !state.canSeek, onChange: onSliderChanged })));
  };
  ...
  const MusicControls = () => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: { marginTop: "10px", marginBottom: "10px", display: "flex" }, "flow-children": "horizontal" },
          window.SP_REACT.createElement(deckyFrontendLib.DialogButton, { style: musicControlButtonStyleFirst, onClick: onClickPrevious },
              window.SP_REACT.createElement(FaFastBackward, { style: { marginTop: "-4px", display: "block" } })),
          window.SP_REACT.createElement(deckyFrontendLib.DialogButton, { style: musicControlButtonStyle, onClick: onClickPlayPause }, state.currentTrackStatus == "Playing" ? (window.SP_REACT.createElement(FaPause, { style: { marginTop: "-4px", display: "block" } })) : (window.SP_REACT.createElement(FaPlay, { style: { marginTop: "-4px", display: "block" } }))),
          window.SP_REACT.createElement(deckyFrontendLib.DialogButton, { style: musicControlButtonStyle, onClick: onClickNext },
  ...
  const VolumeControl = () => {
      ...
      if (!state.hasAvailableTrack || !state.canModifyVolume)
          return window.SP_REACT.createElement("div", null);
      return (window.SP_REACT.createElement("div", null,
          window.SP_REACT.createElement("div", { style: { marginTop: "5px" }, className: deckyFrontendLib.staticClasses.PanelSectionTitle }, "Playback Volume"),
          window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
              window.SP_REACT.createElement(deckyFrontendLib.SliderField, { value: Math.round(state.currentVolume * 100), min: 0, max: 100, step: 1, onChange: onSliderChanged }))));
  };
  ...
  const Content = () => {
      ...
      const updateTrackData = () => {
          resolve(getMetaData(), (metaData) => {
              ...
              if (!state.isSeeking) {
                  resolve(getTrackProgress(), (progress) => {
                      dispatch({ type: AppActions.SetTrackProgress, value: progress });
                  });
              }
              resolve(triggerTrackStatus(), (status) => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, null,
          window.SP_REACT.createElement("div", { className: deckyFrontendLib.staticClasses.PanelSectionTitle }, "Currently Playing"),
          ...
          window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
              window.SP_REACT.createElement(MediaProviderButton, { currentProvider: state.currentServiceProvider })),
          window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
  ...
  const InfoPage = () => {
      return (window.SP_REACT.createElement(deckyFrontendLib.Focusable, null,
          "MusicControl allows you to control any media playback that is currently running that implements the MPRIS dbus interface. ",
  ...
  const InfoRoute = () => {
      return (window.SP_REACT.createElement(deckyFrontendLib.SidebarNavigation, { title: "MusicControl", showTitle: true, pages: [
              {
                  title: "Info",
