(function (deckyFrontendLib, React) {
    ...
    var index = deckyFrontendLib.definePlugin((serverApi) => {
        ...
        const soundVolumePatchInstance = deckyFrontendLib.afterPatch(AudioParent.m_GamepadUIAudioStore.m_AudioPlaybackManager.__proto__, "GetActiveDestination", function (_, ret) {
