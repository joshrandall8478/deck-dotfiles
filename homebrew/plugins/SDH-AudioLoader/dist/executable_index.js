(function (deckyFrontendLib, React) {
  ...
  function getAndSetSoundPacks() {
      const setGlobalState = globalState$1.setGlobalState.bind(globalState$1);
      return server$1.callPluginMethod("get_sound_packs", {}).then((data) => {
          if (data.success) {
  ...
  function reloadBackend() {
      return server$1.callPluginMethod("parse_packs", {}).then(() => {
          getAndSetSoundPacks();
      });
  }
  function dummyFuncTest() {
      const setGlobalState = globalState$1.setGlobalState.bind(globalState$1);
      server$1.callPluginMethod("dummy_function", {}).then((res) => {
          if (res.success) {
  ...
  function downloadThemeFromUrl(themeId) {
      ...
      return server$1.callPluginMethod("download_theme_from_url", {
          id: themeId,
          url: apiUrl,
      });
  }
  ...
  function deletePack(name) {
      return server$1.callPluginMethod("delete_pack", { name: name });
  }
  function getConfig() {
      return server$1.callPluginMethod("get_config", {});
  }
  function setConfig(configObj) {
      return server$1.callPluginMethod("set_config", { configObj: configObj });
  }
  ...
  function getThemes(searchOpts, apiPath, globalStateVarName, setSnapIndex, requiresAuth = false) {
      const setGlobalState = globalState.setGlobalState.bind(globalState);
      const queryStr = generateParamStr(searchOpts.filters !== "All" ? searchOpts : { ...searchOpts, filters: "" }, "AUDIO.");
  ...
  function findMapping(origFileName, mappings) {
      if (mappings && Object.keys(mappings || {}).includes(origFileName)) {
          const mappedFiles = mappings[origFileName];
          const randIndex = Math.trunc(Math.random() * mappedFiles.length);
          return mappedFiles[randIndex];
      }
      return origFileName;
  }
  function createFullPath(fileName, truncatedPackPath) {
      return `/sounds_custom/${truncatedPackPath || "error"}/${fileName}`;
  }
  function changeMenuMusic(newMusic, menuMusic, setGlobalState, gamesRunning, soundPacks, musicVolume) {
      ...
      if (newMusic !== "None" && gamesRunning.length === 0) {
          ...
          const musicFilePath = createFullPath(findMapping("menu_music.mp3", currentPack?.mappings), currentPack?.truncatedPackPath);
          const introFilePath = createFullPath(findMapping("intro_music.mp3", currentPack?.mappings), currentPack?.truncatedPackPath);
          let newMenuMusic;
          ...
          function playAndLoopMenuMusic(wasFromIntro = false) {
              newMenuMusic.play();
          ...
          function createWindowObject(menuMusic) {
  ...
  const AudioParent = deckyFrontendLib.findModuleChild((m) => {
      if (typeof m !== "object")
          return undefined;
      for (let prop in m) {
  ...
  const GlobalStateContextProvider = ({ children, globalStateClass }) => {
      ...
      const getGlobalState = (key) => globalStateClass.getGlobalState(key);
      const setGlobalState = (key, data) => globalStateClass.setGlobalState(key, data);
  ...
  const UninstallPage = () => {
      ...
      function handleUninstall(listEntry) {
          ...
          resolve(deletePack(listEntry.name), () => {
              reloadBackend().then(() => {
      ...
      if (soundPacks.length === 0) {
          return (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
              window.SP_REACT.createElement("span", null, "No custom packs installed, find some in the 'Browse' tab.")));
      }
      return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
          window.SP_REACT.createElement("div", null,
              window.SP_REACT.createElement("div", null, soundPacks.map((e) => {
                  let [updateStatus, remoteEntry] = ["installed", false];
  ...
  const SettingsPage = () => {
      const { apiShortToken, apiFullToken, apiMeData } = useGlobalState();
      ...
      window.SP_REACT.createElement("div", null,
              ...
              apiFullToken ? (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                  ...
                  window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: { display: "flex", alignItems: "center", width: "100%" } },
                      window.SP_REACT.createElement("div", { style: { minWidth: "65%", marginRight: "auto" } },
                          window.SP_REACT.createElement(deckyFrontendLib.TextField, { disabled: !!apiFullToken, label: "DeckThemes Account Key", bIsPassword: true, value: shortTokenInterimValue, onChange: (e) => setShortTokenIntValue(e.target.value) })),
          ...
          window.SP_REACT.createElement(deckyFrontendLib.Focusable, null,
              window.SP_REACT.createElement("div", null,
                  window.SP_REACT.createElement("h1", { style: { fontWeight: "bold", fontSize: "2em", marginBottom: "0px" } }, "About AudioLoader"),
                  window.SP_REACT.createElement("div", { style: { display: "flex", gap: "4em", fontSize: "0.9em" } },
                      window.SP_REACT.createElement("div", null,
                          window.SP_REACT.createElement("h2", { style: {
                                  fontWeight: "bold",
                                  fontSize: "1.5em",
                                  marginBottom: "0px",
                              } }, "Developers"),
                      ...
                      window.SP_REACT.createElement("div", null,
                          ...
                          window.SP_REACT.createElement("span", null,
                              "Instructions for theme creation/submission are available on DeckThemes' docs website.",
                              window.SP_REACT.createElement("br", null),
                              "docs.deckthemes.com")))))));
  };
  ...
  const PackDisplayCard = ({ data: e, refPassthrough = undefined, searchOpts, prevSearchOptsVarName, }) => {
      const { soundPacks, apiUrl, setGlobalState } = useGlobalState();
      function checkIfPackInstalled(themeObj) {
          const filteredArr = soundPacks.filter((e) => e.name === themeObj.name && e.author === themeObj.specifiedAuthor);
      ...
      window.SP_REACT.createElement("div", { style: { position: "relative" } },
          installStatus === "outdated" && (window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_SingleItem_NotifBubble", style: {
              ...
              window.SP_REACT.createElement(AiOutlineDownload, null))),
          window.SP_REACT.createElement(deckyFrontendLib.Focusable, { ref: refPassthrough, onActivate: () => {
                  setGlobalState(prevSearchOptsVarName, searchOpts);
                  setGlobalState("currentExpandedTheme", e);
                  deckyFrontendLib.Router.Navigate("/pack-manager-expanded-view");
              }, focusWithinClassName: "gpfocuswithin", className: "AudioLoader_PackBrowser_SingleItem_Container1", style: {
                  width: "220px",
              ...
              window.SP_REACT.createElement("div", { className: "AudioLoader_PackBrowser_SingleItem_Container2", style: {
                  ...
                  window.SP_REACT.createElement("div", { 
                      ...
                      window.SP_REACT.createElement("div", { style: {
                              backgroundImage: e.target === "Music"
          ...
          window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
              window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: { display: "flex", maxWidth: "100%" } },
                  window.SP_REACT.createElement("div", { style: {
                      ...
                      window.SP_REACT.createElement(deckyFrontendLib.Dropdown, { menuLabel: "Sort", rgOptions: formattedFilters.order, strDefaultLabel: "Last Updated (Newest)", selectedOption: searchOpts.order, onChange: (e) => {
                              setGlobalState(prevSearchOptsVarName, searchOpts);
                  ...
                  window.SP_REACT.createElement("div", { className: "CSSLoader_FilterDropDown_Container", style: {
                      ...
                      window.SP_REACT.createElement(deckyFrontendLib.Dropdown, { menuLabel: "Filter", rgOptions: formattedFilters.filters, strDefaultLabel: "All", selectedOption: searchOpts.filters, onChange: (e) => {
                              setGlobalState(prevSearchOptsVarName, searchOpts);
                              setGlobalState(searchOptsVarName, {
                                  ...searchOpts,
                                  filters: e.data,
          ...
          window.SP_REACT.createElement("div", { style: { display: "flex", justifyContent: "center" } },
              window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: { display: "flex", alignItems: "center", width: "96%" } },
                  window.SP_REACT.createElement("div", { style: { minWidth: "55%", marginRight: "auto" } },
                      window.SP_REACT.createElement(deckyFrontendLib.TextField, { label: "Search", value: searchOpts.search, onChange: (e) => {
                              setGlobalState(prevSearchOptsVarName, searchOpts);
                              setGlobalState(searchOptsVarName, {
                                  ...searchOpts,
  ...
  function LoadMoreButton({ fetchPath = "/themes", origSearchOpts, themeArr, themeArrVarName, paramStrFilterPrepend = "", setSnapIndex = undefined, }) {
      ...
      function loadMore() {
          ...
          const searchOpts = generateParamStr(searchOptClone.filters !== "All"
              ? searchOptClone
              : { ...searchOptClone, filters: "" }, paramStrFilterPrepend);
  ...
  const PackBrowserPage = () => {
      const { browseThemeList: themeArr, themeSearchOpts: searchOpts, apiShortToken, apiFullToken, serverFilters, prevSearchOpts, } = useGlobalState();
      ...
      return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
          window.SP_REACT.createElement(BrowserSearchFields, { searchOpts: searchOpts, searchOptsVarName: "themeSearchOpts", prevSearchOptsVarName: "prevSearchOpts", unformattedFilters: serverFilters, unformattedFiltersVarName: "serverFilters", getTargetsPath: "/themes/filters?type=AUDIO", onReload: () => {
                  reloadThemes();
              } }),
          window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: {
                  display: "flex",
                  ...
                  rowGap: "5px",
                  columnGap: "5px",
              } }, themeArr.items.map((e, i) => (window.SP_REACT.createElement(PackDisplayCard, { refPassthrough: i === indexToSnapTo ? endOfPageRef : undefined, data: e, searchOpts: searchOpts, prevSearchOptsVarName: "prevSearchOpts" })))),
          window.SP_REACT.createElement("div", { style: {
                  marginTop: "1em",
                  marginBottom: "1em",
                  display: "flex",
              ...
              window.SP_REACT.createElement("div", { style: { maxWidth: "50%" } },
                  window.SP_REACT.createElement(LoadMoreButton, { themeArr: themeArr, themeArrVarName: "browseThemeList", origSearchOpts: searchOpts, paramStrFilterPrepend: "AUDIO.", fetchPath: "/themes", setSnapIndex: setSnapIndex })))));
  };

  function StarredPacksPage() {
      const { apiFullToken, apiMeData, starredSearchOpts: searchOpts, starredServerFilters: serverFilters, starredThemeList: themeArr, prevStarSearchOpts: prevSearchOpts, } = useGlobalState();
      function reloadThemes() {
      ...
      return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
          window.SP_REACT.createElement(BrowserSearchFields, { searchOpts: searchOpts, searchOptsVarName: "starredSearchOpts", prevSearchOptsVarName: "prevStarSearchOpts", unformattedFilters: serverFilters, unformattedFiltersVarName: "starredServerFilters", getTargetsPath: "/users/me/stars/filters?type=AUDIO", requiresAuth: true, onReload: reloadThemes }),
          window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: {
                  display: "flex",
                  flexWrap: "wrap",
                  justifyContent: "center",
                  rowGap: "5px",
                  columnGap: "5px",
              } }, themeArr.items.map((e, i) => (window.SP_REACT.createElement(PackDisplayCard, { refPassthrough: i === indexToSnapTo ? endOfPageRef : undefined, data: e, searchOpts: searchOpts, prevSearchOptsVarName: "prevStarSearchOpts" })))),
          window.SP_REACT.createElement("div", { style: {
                  marginTop: "1em",
                  marginBottom: "1em",
                  display: "flex",
              ...
              window.SP_REACT.createElement("div", { style: { maxWidth: "50%" } },
                  window.SP_REACT.createElement(LoadMoreButton, { themeArr: themeArr, themeArrVarName: "starredThemeList", origSearchOpts: searchOpts, paramStrFilterPrepend: "AUDIO.", fetchPath: "/users/me/stars", setSnapIndex: setSnapIndex })))));
  }

  function SubmissionsPage() {
      const { apiFullToken, submissionSearchOpts: searchOpts, submissionServerFilters: serverFilters, submissionThemeList: themeArr, prevSubSearchOpts: prevSearchOpts, apiMeData, } = useGlobalState();
      function reloadThemes() {
      ...
      return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
          ...
          window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: {
                  ...
                  rowGap: "5px",
                  columnGap: "5px",
              } }, themeArr.items.map((e, i) => (window.SP_REACT.createElement(PackDisplayCard, { refPassthrough: i === indexToSnapTo ? endOfPageRef : undefined, data: e, searchOpts: searchOpts, prevSearchOptsVarName: "setPrevSubSearchOpts" })))),
          window.SP_REACT.createElement("div", { style: {
                  marginTop: "1em",
                  marginBottom: "1em",
                  display: "flex",
              ...
              window.SP_REACT.createElement("div", { style: { maxWidth: "50%" } },
                  window.SP_REACT.createElement(LoadMoreButton, { themeArr: themeArr, themeArrVarName: "submissionThemeList", origSearchOpts: searchOpts, paramStrFilterPrepend: "AUDIO.", fetchPath: "/themes/awaiting_approval", setSnapIndex: setSnapIndex })))));
  }
  ...
  const ExpandedViewPage = () => {
      const { soundPacks: installedThemes, currentExpandedTheme, isInstalling, apiUrl, apiFullToken, setGlobalState, } = useGlobalState();
      ...
      console.log("console.log(Navigation)", deckyFrontendLib.Navigation);
      function installTheme() {
          setGlobalState("isInstalling", true);
          resolve(downloadThemeFromUrl(fullThemeData?.id || "ERROR"), () => {
              reloadBackend().then(() => {
              ...
              window.SP_REACT.createElement("div", { style: {
                  ...
                  window.SP_REACT.createElement("div", { style: {
                      ...
                      window.SP_REACT.createElement("div", { 
                          ...
                          window.SP_REACT.createElement("div", { style: {
                                  background: fullThemeData.target === "Music"
                                      ? "url(https://i.imgur.com/nISGpci.png)"
                                      : "linear-gradient(150deg, rgba(0, 0, 0, 0) 0%, rgba(118, 118, 118, 0) 0%, rgba(255, 255, 255, 0.2) 32%, rgba(255, 255, 255, 0.2) 35%, rgba(255, 255, 255, 0.2) 38%, rgba(210, 210, 210, 0) 70%, rgba(0, 0, 0, 0) 100%) 0% 0% / cover",
                                  position: "absolute",
                                  left: "0",
                          ...
                          window.SP_REACT.createElement("div", { className: isInstalling ? "spinny" : "", style: {
                                  backgroundImage: fullThemeData.target === "Music"
                                      ? 'url("https://i.imgur.com/V9t3728.png")'
                                      : 'url("https://i.imgur.com/pWm35T0.png")',
                                  position: "absolute",
                                  top: "2.5%",
                          ...
                          window.SP_REACT.createElement("div", null,
                              !!apiFullToken && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                                      window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_ExpandedView_StarButton", style: {
                                          ...
                                          window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", onClick: toggleStar$1, disabled: blurStarButton },
                                              window.SP_REACT.createElement("div", { style: {
                                                      display: "flex",
                                                      alignItems: "center",
                                                      justifyContent: "center",
                              ...
                              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                                  window.SP_REACT.createElement("div", { className: "CssLoader_ThemeBrowser_ExpandedView_InstallButtonColorFilter", style: {
                                      ...
                                      window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", disabled: installStatus === "installed" || isInstalling, onClick: () => {
                                              installTheme();
                                          } },
  ...
  const Content = ({}) => {
      const { activeSound, gamesRunning, soundPacks, menuMusic, legacyEnabled, selectedMusic, soundVolume, musicVolume, gainNode, dummyFuncResult, setGlobalState, } = useGlobalState();
      React.useEffect(() => {
          dummyFuncTest();
      }, []);
      function restartMusicPlayer(newMusic) {
          changeMenuMusic(newMusic, menuMusic, (key, val) => setGlobalState(key, val), gamesRunning, soundPacks, musicVolume);
      }
      ...
      return (window.SP_REACT.createElement("div", { className: "audioloader_QAM" },
        ...
        `),
          window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "Packs" },
              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                  window.SP_REACT.createElement(deckyFrontendLib.DropdownItem, { bottomSeparator: "none", onMenuWillOpen: () => refetchLocalPacks(), menuLabel: "Sound Pack", rgOptions: SoundPackDropdownOptions, selectedOption: 
                      ...
                      SoundPackDropdownOptions.find((e) => e.label === activeSound)?.data ?? -1, onChange: async (option) => {
                          setGlobalState("activeSound", option.label);
                          const configObj = {
              ...
              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                  window.SP_REACT.createElement(deckyFrontendLib.SliderField, { bottomSeparator: "standard", label: undefined, value: soundVolume, min: 0, max: 1, step: 0.01, onChange: (value) => {
              ...
              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                  window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Enable Legacy Features", description: "Legacy features are unsupported by Audio Loader maintainers. They may break at any time. Issues should be reported on our GitHub. Please do not reach out to us on Discord regarding legacy feature issues.", checked: legacyEnabled, onChange: (value) => {
              ...
              legacyEnabled && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.DropdownItem, { bottomSeparator: "none", onMenuWillOpen: () => refetchLocalPacks(), menuLabel: "Music Pack", rgOptions: MusicPackDropdownOptions, selectedOption: MusicPackDropdownOptions.find((e) => e.label === selectedMusic)?.data ?? -1, onChange: async (option) => {
                              const configObj = {
                                  selected_pack: activeSound,
                              ...
                              setConfig(configObj);
                              restartMusicPlayer(legacyEnabled ? option.label : "None");
                          } })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.SliderField, { bottomSeparator: "standard", label: undefined, value: musicVolume, min: 0, max: 1, step: 0.01, onChange: (value) => {
          ...
          window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "Settings" },
              window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                  window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { bottomSeparator: "none", layout: "below", onClick: () => {
                          deckyFrontendLib.Router.CloseSideMenus();
                          deckyFrontendLib.Router.Navigate("/audiopack-manager");
                      } }, "Manage Packs")))));
  };
  const PackManagerRouter = () => {
      ...
      return (window.SP_REACT.createElement("div", { style: {
          ...
          window.SP_REACT.createElement(deckyFrontendLib.Tabs, { activeTab: currentTab, 
              // @ts-ignore
              onShowTab: (tabID) => {
                      ...
                      ? [
                          {
                              ...
                              content: window.SP_REACT.createElement(StarredPacksPage, null),
                              id: "StarredPacks",
                          },
                  ...
                  {
                      title: "Settings",
                      content: window.SP_REACT.createElement(SettingsPage, null),
  ...
  var index = deckyFrontendLib.definePlugin((serverApi) => {
      ...
      const soundVolumePatchInstance = deckyFrontendLib.afterPatch(AudioParent.m_GamepadUIAudioStore.m_AudioPlaybackManager.__proto__, "GetActiveDestination", async function (_, ret) {
          try {
      ...
      const patchInstance = deckyFrontendLib.beforePatch(AudioParent.GamepadUIAudio.m_AudioPlaybackManager.__proto__, "PlayAudioURL", (args) => {
          ...
          switch (activeSound) {
              ...
              default:
                  ...
                  if (Object.keys(currentPack?.mappings || {}).includes(soundName)) {
                      const mappings = currentPack?.mappings?.[soundName];
                      if (Array.isArray(mappings) && mappings.every(item => typeof item === 'string')) {
                          ...
                          newSoundURL = `/sounds_custom/${currentPack?.truncatedPackPath || "/error"}/${mappedFileName}`;
                          break;
                      }
                  }
                  // Default path-replacing behavior
                  newSoundURL = args[0].replace("sounds/", `sounds_custom/${currentPack?.truncatedPackPath || "/error"}/`);
                  break;
          }
          args[0] = newSoundURL;
          return [newSoundURL];
      ...
      serverApi.routerHook.addRoute("/pack-manager-expanded-view", () => (window.SP_REACT.createElement(GlobalStateContextProvider, { globalStateClass: state },
          window.SP_REACT.createElement(ExpandedViewPage, null))));
      return {
          title: window.SP_REACT.createElement("div", { className: deckyFrontendLib.staticClasses.Title }, "Audio Loader"),
